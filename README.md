...
- **阿里云 / 云效身份治理**：管理阿里云 CLI Profile、云效组织逻辑身份和 Codeup / Flow 等 DevOps 操作边界；PAT、AK/SK 等凭据只走宿主安全通道，不写入 GLOBAL 或项目仓库。
...
→ 询问并连接飞书 / GitHub / Obsidian
→ 配置阿里云/云效身份治理与服务器 Profile → 初始化 GLOBAL 本地 Git
→ 全局个性化提示词 → 项目目录位置教学
→ 通用助手项目打开门禁 → 通用助手总经理
