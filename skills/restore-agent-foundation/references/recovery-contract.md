...
交互验收至少包含 GitHub、飞书、Obsidian和当前宿主的实时发现与身份/可用性回读。不能自动验证的项目必须明确标记，不能推断为通过。
